#codigo de HX normalizado error balance 0%
...
p1 = heatmap(Th_final', title="Temp. Canal Caliente (°C)", cmap=:thermal, xlabel="x-cells", ylabel="y-cells")
p2 = heatmap(Tc_final', title="Temp. Canal Frío (°C)", cmap=:thermal, xlabel="x-cells", ylabel="y-cells")
